ARG BASEIMAGE=public.ecr.aws/docker/library/python:3.13.1-slim-bookworm@sha256:fcbd8dfc2605ba7c2eca646846c5e892b2931e41f6227985154a596f26ab8ed7
...
ENV PYTHONPATH=/usr/src/app/aaa_2

# Make static files
RUN python aaa_2/manage.py collectstatic --noinput
